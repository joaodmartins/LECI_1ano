...
public class VehicleComp {
    ...
    public void printVehicleWithMostKm() {
        ...
        for (Vehicle vehicle : this.vehicles)
            if (vehicle !=null && vehicle.totalDistance() > max.totalDistance())
                max = vehicle;
    ...
    public String toString() {
        return String.format("\nCompany %s%nNumber of vehicles: %d%nTotal distance: %d", this.name, this.vehicles.length, this.totalDistance());
    }
}
